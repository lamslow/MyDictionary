...
import com.example.mydictionary.databinding.ActivityListFavoriteBinding;
...
public class ListFavoriteActivity extends AppCompatActivity implements ListFavoriteView {
    ...
    private ActivityListFavoriteBinding activityListFavoriteBinding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        activityListFavoriteBinding = DataBindingUtil.setContentView
                (this, R.layout.activity_list_favorite);
        toolbar6 = findViewById(R.id.toolbar6);
        toolbar6.setTitle("Danh sách yêu thích A - V");
